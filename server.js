...
let {
  ...
  COFRE_UUID_FILIAL_JUNDIAI,
  COFRE_UUID_REPRESENTANTEEDNA,
...
const COFRES_UUIDS = {
  ...
  'CURITIBA MATRIZ': COFRE_UUID_CURITIBA_MATRIZ,
  'FILIAL JUNDIAI': COFRE_UUID_FILIAL_JUNDIAI,
  'REPRESENTANTE EDNA': COFRE_UUID_REPRESENTANTEEDNA,
...
function getNomeCofreByUuid(uuidCofre) {
  ...
  const mapeamento = {
    ...
    [COFRE_UUID_FILIAL_JUNDIAI]: 'COFRE_UUID_FILIAL_JUNDIAI',
    [COFRE_UUID_REPRESENTANTEEDNA]: 'COFRE_UUID_REPRESENTANTEEDNA',
  ...
  try {
    ...
    if (signers && signers.length > 0) {
      try {
        ...
        await cadastrarSignatarios(D4SIGN_TOKEN, D4SIGN_CRYPT_KEY, uuidDoc, signers, usaTelefone);
